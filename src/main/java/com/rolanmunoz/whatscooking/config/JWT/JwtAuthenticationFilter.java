...
//validar la informacion del token y establece autenticacion en la solicitud actual
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtAuthenticationFilter(CustomUsersDetailsService customUsersDetailsService, JwtTokenProvider jwtTokenProvider) {
